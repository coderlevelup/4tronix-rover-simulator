 ...
 * 
 * SECURITY NOTE: This endpoint should only be accessible to backend services
 * with proper authentication (service account credentials or other verification).
 * Do NOT expose this to client-side requests without proper validation.
 */
